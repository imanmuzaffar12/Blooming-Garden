(function($) {
	$.fn.paginate = function(options) {
	    ...
	    if (opts.count <= 1.0) {
	        $(opts.parentclass).css("display", "none");
	        $(this).css("display", "none");
	    }
	    else {

	        $(opts.parentclass).css("display", "");
	        $(this).css("display", "");
	    }
	    //outsidewidth_tmp = opts.count * 70;
	...
	$.fn.draw = function(o,obj,selectedpage){
		...
		if(o.images){
			...
			var spreviousclass 	= 'icon prev';
			var previousclass 	= 'jPag-previous';
			var snextclass 		= 'icon next';
		...
		for(var i = 0; i < o.count; i++){
			var val = i+1;
			if(val == selectedpage){
                var _obj = $(document.createElement('li')).html('<a class="jPag-current white-bg">'+val+'</a>');
				selobj = _obj;
				_ul.append(_obj);
			}	
			else{
		...
		_ulwrapdiv.find('li').click(function(e){
            ...
            $(this).html('<a class="jPag-current white-bg">'+currval+'</a>');
			selobj = $(this);
	...
	$.fn.applystyle = function(o,obj,a_css,hover_css,_first,_ul,_ulwrapdiv,_divwrapright){
					...
					obj.find('a.jPag-current').css(hover_css);
					obj.find('a').hover(
					function(){
						$(this).css(hover_css);
					},
