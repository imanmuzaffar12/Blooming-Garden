...
(function($) {
    ...
    if ( _mainJS ) {
        ...
        if ( document.querySelector('[data-parallax]') ) {
            ...
            parallax_js.src = '/content/assets/plugins/parallax/parallax.js';
        ...
        if ( document.querySelector('[data-countdown]') ) {
            ...
            countdown_js.src = '/content/assets/plugins/countdown/jquery.countdown.min.js';
        ...
        if ( document.querySelector('[data-scrollbar]') ) {
            ...
            nicescroll_js.src = '/content/assets/plugins/scrollbar/jquery.nicescroll.min.js';
        ...
        if ( (document.querySelector('[data-carousel="owl-carousel"]')) || (document.getElementsByClassName('owl-carousel')) ) {
            ...
            owl_carousel_js.src = '/content/assets/plugins/owl.carousel/owl.carousel.min.js';
